...
protected:
  ...
  Double_t pfu1sigma1Cov[4][4];
  Double_t pfu2sigma1Cov[4][4];
  Double_t pfu1sigma2Cov[4][4];
  Double_t pfu2sigma2Cov[4][4];
  Double_t pfu1sigma0Cov[4][4];
  Double_t pfu2sigma0Cov[4][4]; 
};
...
Double_t dSigma(const TF1 *fcn, const Double_t x, const Double_t cov[4][4]) {
  Double_t df[4];
  Double_t a  = fcn->GetParameter(0);
  Double_t c  = fcn->GetParameter(1);
  Double_t d  = fcn->GetParameter(2);
